...
{
    [VerifyUserAttribute]
    public class MedtronicCustomerController : Controller
    {
        ...
        public JsonResult TotalRecordCount(Search_Admin tB_Admin)
        {
            ...
            try
            {
                cmd = new SqlCommand("Get_TB_MedtronicCustomer_Count", con);
        ...
        {
            cmd = new SqlCommand("SP_Get_MedtronicCustomer_Customer", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public ActionResult AddAdmin(CustomerMaster tB_admin)
        {
            ...
            try
            {
                cmd = new SqlCommand("Insert_Medtronic_customer", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int AddFirm(CustomerMaster tB_admin)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@FIRM_NAME", 3);
                cmd.Connection = con;
                if (con.State == System.Data.ConnectionState.Open)
                {
                    con.Close();
        ...
        public ActionResult EditAdmin(CustomerMaster tB_admin)
        {
            ...
            try
            {
                cmd = new SqlCommand("Update_Medtronic_customer", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@CUSTOMER_NAME", tB_admin.CUSTOMER_NAME);
                cmd.Parameters.AddWithValue("@FIRM_NAME", tB_admin.FIRM_NAME);
                cmd.Parameters.AddWithValue("@CONTACT_NO", tB_admin.CONTACT_NO);
