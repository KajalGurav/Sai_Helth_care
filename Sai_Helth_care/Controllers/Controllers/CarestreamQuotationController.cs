...
{
    [VerifyUserAttribute]
    public class CarestreamQuotationController : Controller
    {
        ...
        public JsonResult TotalRecordCount(Search_Admin tB_Admin)
        {
            ...
            try
            {
                cmd = new SqlCommand("Get_TB_CarestreamQuotation_Count", con);
        ...
        {
            cmd = new SqlCommand("SP_GetTB_CarestreamQuotation", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public ActionResult CarestreamQuotationAdd()
        {
            return View();
        }
        ...
        public ActionResult AddAdmin(QuotationMaster tB_admin)
        {
            try
            {
                cmd = new SqlCommand("Insert_Tb_CarestreamQuotationMaster", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public JsonResult GetCustomerList()
        {
            ...
            var _getadmin = db.Tb_CustomerMaster.Where(z => z.STATUS == "Active" && z.CUSTOMER_TYPE_ID == 4 && z.COMPANY_ID == c_id).OrderBy(x => x.CUSTOMER_NAME).Select(s => new { s.Customer_ID, s.CUSTOMER_NAME, s.FIRM_NAME, s.STATUS, s.REG_DATE }).ToList();
        ...
        public JsonResult GetCarestreamQotDetails()
        {
        ...
        //Bind/ Get Accessories( SPARE_PART ) Table
        ...
        public ActionResult Delete_Admin(QuotationMaster tB_admin)
        {
            try
            {
                ...
                //int i = Convert.ToInt32(cmd.ExecuteScalar());
                //con.Close();
                int i = CommonCode.Delete_Admin.deleteData(tB_admin.QUOTATION_ID, tB_admin.SPARE_PART, tB_admin.PRODUCT_NAME);
