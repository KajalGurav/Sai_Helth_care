...
namespace Sai_Helth_care.Controllers
{
    ...
    public class MindrayQuotationController : Controller
    {
        ...
        {
            bool result = false;  // Declare 'result' once
            ...
            try
            {
                cmd = new SqlCommand("Update_MQuotationProductDetails", con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                cmd.Parameters.AddWithValue("@PSQ_ID", tB_Admin.PSQ_ID);
                cmd.Parameters.AddWithValue("@PSPRICE_ID", tB_Admin.PSPRICE_ID);
                cmd.Connection = con;
            ...
            // Return the result (instead of always returning 'false')
