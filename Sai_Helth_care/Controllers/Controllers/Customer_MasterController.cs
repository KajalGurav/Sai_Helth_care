...
namespace Sai_Helth_care.Controllers
{
    ...
    public class Customer_MasterController : Controller
    {
        ...
        public ActionResult ExportToExcel(string CustType, string CUSTOMER_NAME)
        {
            // Set the license context
            ExcelPackage.LicenseContext = LicenseContext.NonCommercial;
            ...
            using (var package = new ExcelPackage())
            {
                ...
                var customers = db.Tb_CustomerMaster
                                 .Where(c => c.CUSTOMER_TYPE_ID == customerTypeId
                                         && (string.IsNullOrEmpty(CUSTOMER_NAME) || c.CUSTOMER_NAME.Equals(CUSTOMER_NAME, StringComparison.OrdinalIgnoreCase)))
                                 .ToList();
                ...
                string excelName = $"CustomerData_{CustType}_{DateTime.Now:yyyyMMddHHmmssfff}.xlsx";
