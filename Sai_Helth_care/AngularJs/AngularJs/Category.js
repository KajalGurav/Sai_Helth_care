app.service("CategoryService", function ($http) {
    ...
    this.ProductCategoryExport = function (SearchingConditions) {
        debugger
        console.log("Hiii its ");
        var response = $http({

            method: "POST",
            url: "/PRoduct_Master/ProductCategoryExport",
...
app.controller("CategoryCtrl", function ($scope, CategoryService) {
    ...
    function ProductCategoryExport() {
        ...
        var getrecord = CategoryService.ProductCategoryExport(SearchingConditions);
        getrecord.then(function (response) {
            if (response.status === 404) {
                ...
                link.download = 'Regular_Product_Report.xls';
                link.click();
                $("#loader").css("display", 'none');
            }
        }, function () {
