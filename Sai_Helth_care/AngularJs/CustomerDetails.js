...
app.controller('CustomerDetailsController', function ($scope, CustomerService)
{
    ...
    $scope.GetProductDetails = function () {
        ...
        //if ($scope.CUSTOMER_TYPE === 3 || $scope.CUSTOMER_TYPE === "3") {
        //    if ($scope.PAYMENT_RECEIPT_TYPE === "Quotation" || $scope.PAYMENT_RECEIPT_TYPE === "PurchaseOrder") {
        //        var recordList = $scope.CustomerRecordList.filter(x => x.Quot_ID == $scope.RECORD_ID)[0];
        //        $scope.RECIEPT_FOR = recordList.RECEIPT_FOR;
        ...
        //        var Firm = $scope.PaymentCustomerFirmList.filter(x => x.F_ID == id)[0];
        //        $scope.CUSTOMER_TYPE = Firm.CUSTOMER_TYPE_ID;
        //        if ($scope.CUSTOMER_TYPE === 1 || $scope.CUSTOMER_TYPE === "1") {
        //            if ($scope.PAYMENT_RECEIPT_TYPE === "Quotation" || $scope.PAYMENT_RECEIPT_TYPE === "PurchaseOrder") {
        //                if ($scope.ProductDetailsList.length > 0) {
        //                    for (i = 0; i < $scope.ProductDetailsList.length; i++) {
        //                        var pos = i + 1;
        //                        $scope.PRODUCT_NAME = $scope.PRODUCT_NAME.concat((pos).toString().concat(") Refurbished "), $scope.ProductDetailsList[i].M_NAME.concat(" ", $scope.ProductDetailsList[i].PRODUCTNAME.concat(" ", $scope.ProductDetailsList[i].IS_WITH_STANDARD_ACC)));  //Do the math!
        //                        //console.log(parseInt($scope.ProductQuotList[i].PRODUCTPRICE)+ '*'+parseInt($scope.ProductQuotList[i].QUANTITY) +'='+ parseInt($scope.total_PRODUCTPRICE));
        //                        $scope._SPARE_PARTLIST = $scope.ProductDetailsList[i].SPARE_PARTLIST;
        ...
        //                    }
        //                }
        //                $scope.RECIEPT_FOR = $scope.PRODUCT_NAME;
        //                var getAdmin1 = CustomerService.GetProductDetails(tb_Admin);
        //                getAdmin1.then(function (response) {
        //                    $scope.ProductDetList = response.data;
        //                    $scope.TOTAL_AMOUNT = $scope.ProductDetList[0].AMOUNT_WITH_TAX;
        ...
        //            }
        //        }
        //        else if ($scope.CUSTOMER_TYPE === 5 || $scope.CUSTOMER_TYPE === "5") {
        //            if ($scope.PAYMENT_RECEIPT_TYPE === "Quotation" || $scope.PAYMENT_RECEIPT_TYPE === "PurchaseOrder") {
        //                if ($scope.ProductDetailsList.length > 0) {
        //                    $scope.PRODUCT_NAME = "Mindray Make";
        //                    for (i = 0; i < $scope.ProductDetailsList.length; i++) {
        //                        if (i < $scope.ProductDetailsList.length - 1) {
        //                            $scope.PRODUCT_NAME = $scope.PRODUCT_NAME.concat(" ", $scope.ProductDetailsList[i].PRODUCTNAME.concat(" ", $scope.ProductDetailsList[i].IS_WITH_PROBE_ACC.concat(" ", "&")));
        //                        }
        //                        else {
        //                            $scope.PRODUCT_NAME = $scope.PRODUCT_NAME.concat(" ", $scope.ProductDetailsList[i].PRODUCTNAME.concat(" ", $scope.ProductDetailsList[i].IS_WITH_PROBE_ACC));  //Do the math!
        //                        }
        //                        //console.log(parseInt($scope.ProductQuotList[i].PRODUCTPRICE)+ '*'+parseInt($scope.ProductQuotList[i].QUANTITY) +'='+ parseInt($scope.total_PRODUCTPRICE));
        //                        //$scope._PROBE_PARTLIST = $scope.ProductDetailsList[i].PROBE_PARTLIST;
        ...
        //                    for (i = 0; i < $scope.ProductDetailsList.length; i++) {
        //                        var pos = i + 1;
        //                        $scope.PRODUCT_NAME = $scope.PRODUCT_NAME.concat((pos).toString().concat(")"), $scope.ProductDetailsList[i].M_NAME.concat(" ", $scope.ProductDetailsList[i].PRODUCTNAME.concat(" ", $scope.ProductDetailsList[i].IS_WITH_STANDARD_ACC)));  //Do the math!
        //                        //console.log(parseInt($scope.ProductQuotList[i].PRODUCTPRICE)+ '*'+parseInt($scope.ProductQuotList[i].QUANTITY) +'='+ parseInt($scope.total_PRODUCTPRICE));
        //                        $scope._SPARE_PARTLIST = $scope.ProductDetailsList[i].SPARE_PARTLIST;
        ...
        //        }
        //        console.log($scope.ProductDetailsList);
        //        //alert(JSON.stringify($scope.ProductDetailsList));
        //    });
        //}
    }
