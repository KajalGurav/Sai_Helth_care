app.service("CustomerService", function ($http) {
    ...
    this.TotalRecordCount = function (SearchingConditions) {
        var response = $http({
            method: "POST",
            url: "/CarestreamCustomer/TotalRecordCount",
    ...
    this.getRecordbyPaging = function (SearchingConditions) {
        var response = $http({
            method: "POST",
            url: "/CarestreamCustomer/GetallAdmin",
            data: JSON.stringify(SearchingConditions)
        });
        return response;
    };
    ...
    this.AddAdmin = function (tb_Admin) {
        var response = $http({
            method: "POST",
            url: "/CarestreamCustomer/AddAdmin",
    ...
    this.EditAdmin = function (tb_Admin) {
        var response = $http({
            method: "POST",
            url: "/CarestreamCustomer/EditAdmin",
            data: JSON.stringify(tb_Admin),
            dataType: "json"
        });
        return response;
    ...
    this.GetState = function () {
        return $http.get("/CarestreamCustomer/GetState");
    };
    ...
    this.GetCity = function (id) {
        var response = $http({
            method: "POST",
            url: "/CarestreamCustomer/GetCity",
            params: {
                id: id
            }
        });
...
app.controller("CarestreamCtrl", function ($scope, CustomerService) {
    ...
    function GetRecordbyPaging() {
        ...
        getrecord.then(function (response) {
            $scope.CarestreamList = response.data;
            $("#loader").css("display", 'none');
            ;
        }, function () {
            $.notify("Error to load data...", "error");
