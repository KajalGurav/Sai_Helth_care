app.service("QuotationService", function ($http) {
    ...
    this.TotalRecordCount = function (SearchingConditions) {
        var response = $http({
            method: "POST",
            url: "/CarestreamQuotation/TotalRecordCount",
    ...
    this.getRecordbyPaging = function (SearchingConditions) {
        var response = $http({
            method: "POST",
            url: "/CarestreamQuotation/GetallAdmin",
            data: JSON.stringify(SearchingConditions)
        });
        return response;
    };
    ...
    this.GetCustomerList = function () {
        return $http.get("/CarestreamQuotation/GetCustomerList");
    };

    this.GetFirmList = function (id) {
        var response = $http({
            method: "POST",
            url: "/CarestreamQuotation/GetFirmList",
            params: {
                id: id
            }
        });
    ...
    this.AddAdmin = function (tb_Admin) {
        var response = $http({
            method: "POST",
            url: "/CarestreamQuotation/AddAdmin",
    ...
    this.EditAdmin = function (tb_Admin) {
        var response = $http({
            method: "POST",
            url: "/CarestreamQuotation/EditAdmin",
            data: JSON.stringify(tb_Admin),
            dataType: "json"
        });
        return response;
    ...
    this.GetProduct = function () {
        return $http.get("/CarestreamQuotation/GetProduct");
    };
    ...
    this.GetSparepart = function (id) {
        var response = $http({
            method: "POST",
            url: "/CarestreamQuotation/GetSparepart",
            params: {
                id: id
            }
        });
    ...
    this.GetCarestreamQotDetails = function () {
        return $http.get("/CarestreamQuotation/GetCarestreamQotDetails");
    };
    ...
    this.AddProductDetails = function (tb_Admin) {
       // alert(tb_Admin.CUSTOMER_ID);
        var response = $http({
            method: "POST",
            url: "/CarestreamQuotation/AddProductDetails",
            data: JSON.stringify(tb_Admin),
            dataType: "json"
        });
        return response;
    ...
    this.GetProductDetails = function () {
        return $http.get("/CarestreamQuotation/GetProductDetails");
    };
    ...
    this.Admin_Delete = function (tb_Admin) {
        var response = $http({
            method: "POST",
            url: "/CarestreamQuotation/Delete_Admin",
            data: JSON.stringify(tb_Admin),
            dataType: "json"
        });
        return response;
    ...
    this.GetCompanyBankDetails = function () {
        return $http.get("/CarestreamQuotation/GetCmpnyBankDetails");
    };
    this.GetProductQuotDetails = function () {
        //to get details in specific format
        return $http.get("/CarestreamQuotation/GetProductQuotDetails");
    };
    this.GetProducDetails = function () {
        //to get details in specific format
        return $http.get("/CarestreamQuotation/GetProducDetails");
    };
    ...
    this.GetLatestRecords = function (idType) {
        var response = $http({
            method: "GET",
            url: "/CarestreamQuotation/GetLatestRecordByType",
            params: {
                idType: idType
            }
        });
...
app.controller("CarestreamQuotationCtrl", function ($scope, QuotationService) {
    var splitted = window.location.pathname.split('/');
    splitted.pop();
    if (splitted.join('/') === "/CarestreamQuotation/ViewQuote") {
        GetQuotation();
        GetAllProduct();
    ...
    else if (window.location.pathname === "/CarestreamQuotation/Index") {
        $("#loader").css("display", '');
        $scope.PageNo = 1;
        $scope.pageSize = 10;
    ...
    else if (window.location.pathname === "/CarestreamQuotation/CarestreamQuotationAdd") {
        GetAllCustomer();
        GetLatestRecord();
    ...
    function GetRecordbyPaging() {
        ...
        getrecord.then(function (response) {
            $scope.CarestreamQuotationList = response.data;
          ...
          //  $scope.Q_ID = $scope.CarestreamQuotationList[0].Q_ID;
          //  $scope.QUOTATION_TYPE = $scope.CarestreamQuotationList[0].QUOTATION_TYPE;
          //  $scope.CUSTOMER_ID = $scope.CarestreamQuotationList[0].CUSTOMER_ID;
          //  $scope.FIRM_ID = $scope.CarestreamQuotationList[0].FIRM_ID;
          //  $scope.QUOTATION_DATE = $scope.CarestreamQuotationList[0].QUOTATION_DATE;
          //  $scope.PNDT_STATUS = $scope.CarestreamQuotationList[0].PNDT_STATUS;
          //  $scope.PNDT_NO = $scope.CarestreamQuotationList[0].PNDT_NO;
          //  $scope.STATUS = $scope.CarestreamQuotationList[0].STATUS;
          //  $scope.PO_DATE = $scope.CarestreamQuotationList[0].PO_DATE;
          //  $scope.PAYMENT_TERM = $scope.CarestreamQuotationList[0].PAYMENT_TERM;
          //  $scope.NOTE = $scope.CarestreamQuotationList[0].NOTE;
    ...
    function GetQuotation() {
        var getAdmin = QuotationService.GetCarestreamQotDetails();
        getAdmin.then(function (response) {
    ...
    function AddAdminRecord(tb_Admin) {
        ...
        datalist.then(function (d) {
            if (d.data.success === true) {
                ...
                $("#loader").css("display", 'none');
                window.location.href = "/CarestreamQuotation/Index";
            }
    ...
    $scope.GotoPage = function (Sparepart) {
        ...
        window.location.href = "/CarestreamQuotation/ViewQuote/" + $scope.SP_ID;
        alert($scope.SP_ID);
    }
    function AddproductRecord(tb_Admin) {
        ...
        datalist.then(function (d) {
            if (d.data.success === true) {
                ...
                $("#loader").css("display", 'none');
                window.location.href = "/CarestreamQuotation/ViewQuote/" + window.location.pathname.split("/").pop().toString();
            }
            else if (d.data.success === false) {
